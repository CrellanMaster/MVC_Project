...
<h1 class="text-center my-5 py-3">Adicionar novo produto</h1>
<div class="container">
    <div class="row">
        <div class="col-8 mx-auto">
            ...
            <form class="p-5 borber mb-5" method="POST" action="<?php url('product/store'); ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="text" required name="quant" class="form-control" id="quant">
                </div>
